...
model = Sequential()
n, act, init = 803, 'linear', 'glorot_uniform'
...
while learnrate > 10**(-7.1):
    ...
    model.fit(x.train, y.train, validation_data=(x.test,y.test), epochs=1000, batch_size=472, verbose=1, callbacks=[history,early_stopping,modcp])
